...
> = (props) => {
  ...
  const sentinelShadowState = new Map<
    HTMLElement,
    { el: HTMLElement; visible: boolean }
  >();
  ...
  onMount(() => {
    ...
    const observer = new IntersectionObserver((entries) => {
      ...
      isScrollable = ![...sentinelShadowState].every(
  ...
  return (
    <div class={props.class} classList={props.classList}>
      ...
      />
      <div
        class="relative flex items-center overflow-auto no-scrollbar"
  ...
  const setPosition = () => {
    ...
    if (direction === "horizontal") {
      return `position: ${isFirst ? "absolute" : "static"}; top: 0; ${
        ...
        isFirst ? "" : `flex-shrink: 0; ${marginLeft}: -1px;`
      }`;
    }
